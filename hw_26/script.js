...
var randomValue = function randomValue(min, max) {
    min = Math.ceil(min);
    max = Math.ceil(max);
...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        var changeStyle = setInterval(function () {

            var randomIndex = randomValue(0, _this.state.listIndex.length);
            ...
            if (_this.state.listIndex.length == Math.floor(_this.state.list.length / 2)) _this.state.borderWidth = "10px";
